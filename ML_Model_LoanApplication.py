...
# Description: 
# This script builds a machine learning pipeline to predict whether a loan is approved or denied. 
# It involves data cleaning, feature engineering, and handling missing values, 
# followed by training a Random Forest model with feature selection. 
# Hyperparameter tuning is performed using Optuna to optimize model performance. 
# The final model is retrained, tested, and saved for accurate loan approval predictions.
...
# Note: Hyperparameter tuning inspired by ChatGPT / GitHub Copilot was used for debuging and code optimization
